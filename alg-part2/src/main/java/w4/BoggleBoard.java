package w4; /******************************************************************************
 *  Compilation:  javac w4.BoggleBoard.java
 *  Execution:    java  w4.BoggleBoard
...
public class BoggleBoard {
    ...
    /**
     * Returns the letter in row i and col j,
     * with 'Q' representing the two-letter sequence "Qu".
     *
     * @param i the row
     * @param j the col
     * @return the letter in row i and col j
     * with 'Q' representing the two-letter sequence "Qu".
     */
    ...
    /**
     * Unit tests the w4.BoggleBoard data type.
     */
